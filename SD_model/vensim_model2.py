...
@component.add(
    ...
    other_deps={
        "_integ_number_of_bus_routes": {
            "initial": {},
            "step": {"increasing_bus_routes": 1, "number_of_bus_routes": 1},
        }
    },
)
...
_integ_number_of_bus_routes = Integ(
    lambda: increasing_bus_routes() * number_of_bus_routes(),
    lambda: 94,
    "_integ_number_of_bus_routes",
)
...
@component.add(
    ...
    other_deps={
        "_integ_number_of_railway_lines": {
            "initial": {},
            "step": {"increasing_railway_lines": 1, "number_of_railway_lines": 1},
        }
    },
)
...
_integ_number_of_railway_lines = Integ(
    lambda: increasing_railway_lines() * number_of_railway_lines(),
    lambda: 1,
    "_integ_number_of_railway_lines",
)
...
@component.add(
    ...
    other_deps={
        "_integ_number_of_trips_per_railway_line": {
            "initial": {},
            "step": {"increasing_railway_trips": 2},
        }
    },
)
...
_integ_number_of_trips_per_railway_line = Integ(
    lambda: increasing_railway_trips() * increasing_railway_trips(),
    lambda: 75,
    "_integ_number_of_trips_per_railway_line",
)
