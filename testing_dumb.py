...
_subscript_dict, _modules = load_model_data(_root, "testing_dumb")
...
# load modules from modules_testing_dumb directory
exec(load_modules("modules_testing_dumb", _modules, _root, []))
